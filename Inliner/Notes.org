...
*** DONE Identity with Argument Visitor
    ...
    :Effort:   10
    :END:
*** TODO one pass, have an environment for each class: go through its class-level variable declarations and add bindings to its environment
    :PROPERTIES:
    :Effort:   10
    :END:
*** For VarDeclaration or FormalParameter, extend the env
    CLOCK: [2013-04-12 Fri 05:29]--[2013-04-12 Fri 05:33] =>  0:04
*** for method local variable bar, lookup and replace
    CLOCK: [2013-04-12 Fri 05:11]--[2013-04-12 Fri 05:29] =>  0:18
*** TODO for foo.bar (in some other method), lookup bar's newName in foo's Class' environment
**** HashMap<String, HashMap<String, String>> classRenamerMap;
**** build this
**** then, just lookup bar's newName
** TODO Uniquify method in MethodTransformer
** Class duplication
** Method duplication

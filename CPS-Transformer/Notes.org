...
** TODO Take care of nested blocks (??)
...
** TODO k1 is already defined => Check where you add Continuation1 k1; declaration in the continuation method
...
*** Add local variables only AFTER you've got the final method body
    CLOCK: [2013-03-26 Tue 03:48]

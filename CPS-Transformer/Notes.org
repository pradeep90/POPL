...
****** TODO i.e., make k1 the currentContinuation name when instantiating a new continuation inside a continuation method
       CLOCK: [2013-03-24 Sun 15:24]--[2013-03-24 Sun 15:28] =>  0:04
******* Maybe whenever you see "k1 = new ContinuationClasscontinuationMethod0 ()" set currentContinuation name = k1
******* That is the behaviour you want
******* Whenever you instantiate a continuation you intend to make it the current continuation. It's just that for IfStatement, you are defering the insertion of the initStatementsMicro, so the information about kNameCounter++ is lost
******* TODO In fact, make this the default way kNameCounter is updated
***** WhileStatement: append initStatements to the else block of the while method
** TODO Check out why when you have k1, k2, in "else", it's k2.k = k instead of k2.k1 = k1
** DONE k2.object = this

...
**** TODO initStatements
*** Put that method in the class
*** In the original location, put "tmp=this; tmp.whileMethod(arguments)" [see code in makeContinuationClass]
*** Also put "Currclass tmp;" at the beginning of the method

...
package microjavaparser;
import nanojavaparser.syntaxtree.*;
...
public class NanoJavaParser implements NanoJavaParserConstants {
  ...
  final public JumpPoint JumpPoint() throws ParseException {
   NodeChoice n0;
   IfStatement n1;
  ...
  final public MessageSendStatement MessageSendStatement() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   Identifier n3;
  ...
  final public VarRef VarRef() throws ParseException {
   NodeChoice n0;
   DotExpression n1;
   Identifier n2;
    if (jj_2_16(2)) {
  ...
  final public DotExpression DotExpression() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   Identifier n3;
  ...
  public NanoJavaParserTokenManager token_source;

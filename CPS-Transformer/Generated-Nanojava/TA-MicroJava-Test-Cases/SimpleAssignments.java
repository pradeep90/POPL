...
new SATest ( ) . ____Main____ ( new Continuation()  ) ; } }  class SATest { int
   ...
   boolean  x ;  boolean  z ;  ___ContinuationClasscontinuationMethod0  ___k1 ;
   a = 10;  b = 20;  a = a + b;  a = a * b;  a = a - b;  x = a < b;  y = true;
   z = false;  z = y & x ; if ( z ) { a = a + b;  ___k1 = new
   ...
   int  a , Continuation  ___k  ) { boolean  x ;  boolean  z ;
   System.out.println ( a ) ; ___k.call(); }}

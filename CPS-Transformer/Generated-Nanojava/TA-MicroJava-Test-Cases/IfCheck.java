...
new ICTest ( ) . ____Main____ ( new Continuation()  ) ; } }  class ICTest { int
   ...
   check ;  ___ContinuationClasscontinuationMethod0  ___k1 ; a = 1;  b = 100;
   check = false; if ( ! (check) ) { a = a * (a + 1);  ___k1 = new
   ...
   void continuationMethod0 (Continuation  ___k ) { boolean  check ;
   ___ContinuationClasscontinuationMethod1  ___k1 ; if ( b < a ) { a = a + 999;
   ___k1 = new ___ContinuationClasscontinuationMethod1();  ___k1.___k = ___k;
   ___k1.object = this; ___k1.call(); }  else { a = a * (a + 1);  ___k1 = new

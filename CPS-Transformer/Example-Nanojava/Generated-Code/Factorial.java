...
class Fac {
    ...
    public void ComputeFac (int
        ...
        if ( ____writeable____num < 1 ) {
            ...
            ___tmp4 = this;
            ___k2 = new ___ContinuationClasscontinuationMethod1();
            ___k2.num = num;
            ___k2.____writeable____num = ____writeable____num;
            ___k2.
                    ___tmp4 = ___tmp4;
            ___k2.___k = ___k;
            ___k2.object = this;
            ___tmp4.
                    ComputeFac(____writeable____num - 1 , ___k2);
        }
    }
    public void
    continuationMethod0 (int  num , int  num_aux   , Continuation  ___k  ) {
        int
...
class ____NewMainClass____ {
    public void ____Main____ (int  ____arg_length____
        ...
        ___k1.
                ____arg_length____ = ____arg_length____;
        ___k1.___tmp6 = ___tmp6;
        ___k1.
                ___k = ___k;
        ___k1.object = this;
        ___tmp6.ComputeFac(10 , ___k1);
    }
    public
    void continuationMethod2 (int  ____arg_length____ , Fac  ___tmp6   ,
        ...
        int  ___tmp5 ;
        ___tmp5 =
                ___tmp6.____1234ComputeFac4321____;
...
class ___ContinuationClasscontinuationMethod1 extends Continuation {
    ...
    ;
    public void call () {
        object.continuationMethod1(num ,

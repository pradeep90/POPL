...
** TODO MessageSend STATEMENT: get the return value in a temporary variable and send it as a varref expression.
   CLOCK: [2013-02-01 Fri 18:28]
** TODO ELSE: assignment statements - make them happen within the else body itself.
** TODO Have method return value variable in ClassDeclaration
** TODO Counter for temporary variables => getNewTempVarName
** TODO Map temporary variable names to their Types - till then maybe name the Type as TYPE + TEMPNAME
** TODO Proper name for return variables

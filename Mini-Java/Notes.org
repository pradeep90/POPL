...
** TODO Clean up stuff in getNewMainClass
...
*** Return nodelist
** TODO Simple nodes => use ExpansionNode
   CLOCK: [2013-02-01 Fri 13:41]
** TODO Expression
...
*** TODO writable argument 
*** return return value storage variable and MethodDeclaration
** TODO MessageSend
** TODO Maybe have placeholders for temporary variables and then number them uniquely within their scope
** TODO Test microjavaparser Statement for Message Send statement???
** TODO Maybe make complex methods like PrintStatement, Method Declaration, Message Send, etc. return a NodeListOptional of the different nodes they generate.
*** I think you need something more for Message Send, though
** TODO What if there are multiple print statements in a method? Don't declare the print variable more than once.
** TODO Integration test: MainOnly

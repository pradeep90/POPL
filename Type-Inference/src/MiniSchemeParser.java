...
public class MiniSchemeParser implements MiniSchemeParserConstants {
  ...
  final public LetExpression LetExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
  ...
  final public ProcedureExp ProcedureExp() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
  ...
  final public Application Application() throws ParseException {
   NodeToken n0;
   Token n1;
   Expression n2;
  ...
  final public RecExpression RecExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
  ...
  final public RecDeclaration RecDeclaration() throws ParseException {
   NodeToken n0;
   Token n1;
   Identifier n2;
   ProcedureExp n3;
  ...
  public MiniSchemeParserTokenManager token_source;

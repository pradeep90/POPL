...
** DONE occursIn Visitor
   ...
   :Effort:   10
   :END:
** TODO Then, write a Unifier class
...
** TODO See if (UnknownType, UnknownType) should be false in areSameBasicType
** TODO When extending unification (TypeEnvironment), make sure you update all existing bindings with the new substitution
